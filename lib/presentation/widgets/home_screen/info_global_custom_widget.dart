...
class _SavingsBubble extends StatelessWidget {
  ...
  const _SavingsBubble({required this.savingsState, required this.isGoalMet, required this.humanizeNumbers});
        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(value: savingsState.progress, minHeight: 3, backgroundColor: (isGoalMet ? Colors.green : Colors.orange).withValues(alpha: 0.1), valueColor: AlwaysStoppedAnimation<Color>(isGoalMet ? Colors.green : Colors.orange)),
            ),
            const SizedBox(height: 4),
            FittedBox(
              fit: BoxFit.scaleDown,
              child: Text('Meta: ${humanizeNumbers.number(savingsState.savingGoal)}€', style: TextStyle(fontSize: 8, fontWeight: FontWeight.w800, color: isGoalMet ? Colors.green.withValues(alpha: 0.7) : Colors.orange.withValues(alpha: 0.7))),
            ),
          ],
        ),
      ),
